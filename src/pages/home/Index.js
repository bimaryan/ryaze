      ...
      <main className="max-w-2xl mx-auto p-6 mt-14">
        ...
        <section className="space-y-4 mt-14">
          ...
          <div className="relative overflow-hidden whitespace-nowrap w-full">
            <div className="flex items-center gap-6 animate-marqueeLeft">
              {/* JavaScript */}
              <div className="flex items-center gap-2 px-4 py-2 bg-gray-200 dark:bg-gray-800 rounded-lg shadow-md w-full min-w-max">
                <img
        ...
        <section className="space-y-6 mt-14">
          ...
          {[
            ...
            <div
              key={index}
              className="bg-gray-100 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6 shadow-md hover:scale-105 transition-transform"
            >
